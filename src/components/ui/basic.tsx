...
export const Input=({className,...p}:React.InputHTMLAttributes<HTMLInputElement>)=><input className={cn('h-10 rounded-xl border border-slate-200 bg-white px-3 text-sm outline-none transition focus:border-blue-300 focus:ring-2 focus:ring-blue-500',className)} {...p}/>;
export const Textarea=({className,...p}:React.TextareaHTMLAttributes<HTMLTextAreaElement>)=><textarea className={cn('min-h-20 rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm outline-none transition focus:border-blue-300 focus:ring-2 focus:ring-blue-500',className)} {...p}/>;
export const Select=({className,children,...p}:React.SelectHTMLAttributes<HTMLSelectElement>)=><select className={cn('h-10 rounded-xl border border-slate-200 bg-white px-3 text-sm outline-none transition focus:border-blue-300 focus:ring-2 focus:ring-blue-500',className)} {...p}>{children}</select>;
